...
export class LanguageService {
  ...
  private languageConfigInSubject = new BehaviorSubject<LanguageCofig>(
    this.defaultLanuageConfig
  );
  ...
  constructor() {
    ...
    this.greekConfig.properties.set(
      'home_blurb',
    ...
    Στο μενού θα βείτε όλες τις σχετικές πληροφορίες.
    ...
    this.greekConfig.properties.set(
      'home_cpl_header',
      'ΣΑΣ ΚΑΛΟΥΜΕ ΝΑ ΖΗΣΕΤΕ ΜΑΖΙ ΜΑΣ ΤΗΝ ΠΙΟ ΕΥΤYΧΙΣΜΕΝΗ ΜΕΡΑ ΤΗΣ ΖΩΗΣ ΜΑΣ'
    );
    this.greekConfig.properties.set('home_cpl_subheader', 'Λίγα λόγια για μας');
    this.greekConfig.properties.set(
      'home_cpl_groom',
      'Είσαι ο καλύτερος μου φίλος, μέντορας, συμπαίκτης, έμπνευση και η μεγαλύτερη μου πρόκληση. Αλλά το σημαντικότερο είσαι η αγαπή της ζωής μου και με κάνεις πιο ευτιχισμένη από τι θα μπορούσα να φανταστώ ότι είναι δυνατό.'
    );
    this.greekConfig.properties.set(
      'home_cpl_pride',
      'Αγαπώ την ομορφιά σου, την εφυιά σου, την ευγενική ψυχή σου και τον τρόπο που ξέρεις πάντα να με κάνεις να νίωθω μοναδικός. Πέρα απο τους όρκους αιώνιας αγαπής που θα δώσω την ημέρα του γάμους, ορκίζομαι ότι θα είμαι η πιο ευτιχισμένη απο όλο τον κόσμο.'
    );
    //HomeDetailsInfo
    this.greekConfig.properties.set('home_info_header_cer', 'ΤΕΛΕΤΗ');
    this.greekConfig.properties.set(
      'home_info_subheader_cer',
      'Σκεπαστή Αρένα'
    );
    this.greekConfig.properties.set('home_info_loc1_cer', 'Σκεπαστή | Κρήτη');
    this.greekConfig.properties.set(
      'home_info_loc2_cer',
      'ΕΟ Ρεθύμνου Ηρακλείου, Σκεπαστή'
    );
    this.greekConfig.properties.set('home_info_header_par', 'ΔΕΞΙΩΣΗ');
    this.greekConfig.properties.set(
      'home_info_subheader_par',
      'Σκεπαστή Αρένα'
    );
    ...
    this.greekConfig.properties.set(
      'rsvp_invite_header',
      'Θα σας παρακαλούσαμε να μας απαντήσετε ως τις 1 Ιουλίου για το αν θα παρευρεθείτε!'
    );
    ...
    this.greekConfig.properties.set(
      'rsvp_pos_option_a',
      'Θα παρευρεθώ στην τελετή'
    );
    this.greekConfig.properties.set(
      'rsvp_pos_option_b',
      'Θα παρευρεθώ στο γλέντι'
    );
    this.greekConfig.properties.set(
      'rsvp_contact_header',
    ...
    this.greekConfig.properties.set(
      'rsvp_lastname',
      'Eισάγετε το επίθετό σας*'
    );
    this.greekConfig.properties.set(
      'rsvp_phone',
      'Eισάγετε το τηλέφωνό σας (Προαιρετικό)'
    );
    this.greekConfig.properties.set(
      'rsvp_email',
      'Eισάγετε το email σας (Προαιρετικό)'
    );
    ...
    this.greekConfig.properties.set(
      'rsvp_extra_attendee',
      'Παρακαλώ εισάγετε ονοματεπώνυμο'
    );
    ...
    this.greekConfig.properties.set(
      'contact_header',
      'Συμπληρώστε την παρακάτω φόρμα με την ερώτησή σας και θα επικοινωνήσουμε μαζί σας το συντομότερο δυνατόν'
    );
    this.greekConfig.properties.set(
      'contact_firstname',
    ...
    this.greekConfig.properties.set(
      'info_flight1_header',
      'Αθήνα (ATH) Ηράκλειο (HER) πτήσεις'
    );
    this.greekConfig.properties.set(
      'info_flight2_header',
      'Θεσσαλονίκη (SKG) Ηράκλειο (HER) πτήσεις'
    );
    this.greekConfig.properties.set(
      'info_flight_number',
      'Εβδομαδιαίες πτήσεις'
    );
    ...
    this.greekConfig.properties.set(
      'info_flight_explore_btn',
      'Δείτε δρομολόγια'
    );
    this.greekConfig.properties.set(
      'info_ferry_header',
      'Πειραιάς προς Ηράκλειο ακτοπλοϊκά'
    );
    ...
    this.greekConfig.properties.set(
      'info_ferry_explore_btn',
      'Δείτε δρομολόγια'
    );
    this.greekConfig.properties.set('info_stay_header', 'Που να μείνετε...');
    this.greekConfig.properties.set(
      'info_stay_subheader',
      'Βρείτε το κατάλληλο μέρος για να απολάυσετε τη διαμονή σας'
    );
    this.greekConfig.properties.set(
      'info_stay_recommendations',
      'Οι προτάσεις μας με βάση την απόσταση από την τοποθεσία του γάμου:'
    );
    ...
    this.greekConfig.properties.set(
      'info_stay_explore_more',
      'ΔΕΙΤΕ ΠΕΡΙΣΣΟΤΕΡΑ'
    );
    this.greekConfig.properties.set(
      'info_stay_additional',
      'Μπορείτε επίσης να ταξιδέψετε αεροπορικά απο Αθήνα και Θεσσαλονίκη ή ακτοπλοϊκά από Πειραιά προς Χανιά, αλλά προτείνουμε το Ηράκλειο, καθώς είναι πιο κοντά στην τοποθεσία του γάμου.'
    );
    ...
    this.greekConfig.properties.set(
      'info_stay_useful_phones',
      'Χρήσιμα Τηλέφωνα'
    );
    this.greekConfig.properties.set(
      'info_stay_useful_phones1',
      'Κέντρο Υγείας Περάματος'
    );
    this.greekConfig.properties.set(
      'info_stay_useful_phones2',
      'Κέντρο Υγείας Ανωγείων'
    );
    this.greekConfig.properties.set(
      'info_stay_useful_phones3',
      'Γενικό Νοσοκομείο Ρεθύμνου'
    );
    this.greekConfig.properties.set(
      'info_stay_useful_phones4',
      'Α.Τ. Περάματος'
    );
    this.greekConfig.properties.set(
      'info_stay_useful_phones5',
      'Τροχαία Ρεθύμνου'
    );
    this.greekConfig.properties.set(
      'info_stay_useful_phones6',
      'Πυροσβεστική Περάματος'
    );
    this.greekConfig.properties.set(
      'info_stay_useful_phones7',
      'Πυροσβεστική Ρεθύμνου'
    );
    this.greekConfig.properties.set(
      'info_stay_useful_phones_btn',
      'Πατήστε παραπάνω για κλήση'
    );

    //About Page
    this.greekConfig.properties.set(
      'about_header',
      'Ο προορισμός που τα έχει όλα!'
    );
    this.greekConfig.properties.set(
      'about_subheader',
      'Σας προτείνουμε να συνδυάσετε τον γάμο μας, με τις καλοκαιρινές σας διακοπές.'
    );
    this.greekConfig.properties.set(
      'about_top_paragraph',
      `Η Κρήτη, το μεγαλύτερο νησί της Ελλάδας, είναι ένας τόπος γοητευτικός, που προσφέρει στον υπέρτατο βαθμό όσα μπορείτε να ονειρευτείτε. Λόγω της στρατηγικής της θέσης, υπήρξε σταυροδρόμι λαών και πολιτισμών, στόχος κατακτητών και κομβικό πέρασμα για Μινωίτες, Μυκηναίους, Οθωμανούς. Άραβες και Ενετούς, που άφησαν πλούσια πολιτιστική παρακαταθήκη στο νησί.
    ...
    this.greekConfig.properties.set(
      'about_places_card1_body',
      `Η πόλη των Χανίων είναι η έδρα του ομώνυμου νομού, μια πόλη όπου η όσμωση διαφορετικών πολιτισμών ανά τους αιώνες άφησε το χαρακτηριστικό της σημάδι. Η περιπλάνηση στους λαβυρινθώδεις δρόμους της Παλιάς Πόλης με τις επιβλητικές βενετσιάνικες οικίες, τις κρήνες και τους περικαλλείς ναούς αποτελεί...`
    );
    ...
    this.greekConfig.properties.set(
      'about_places_card2_body',
      `Η πόλη του Ρεθύμνου είναι μια από τις καλύτερα διατηρημένες μεσαιωνικές πόλεις της Ελλάδας: οι ενετικές οχυρώσεις σμίγουν αρμονικά με τις εκκλησιές των ορθοδόξων και των καθολικών, τις επιβλητικές κατοικίες των Βενετών, τις αψίδες και τις πλακόστρωτες οδούς δημιουργώντας μια ατμόσφαιρα...`
    );
    ...
    this.greekConfig.properties.set(
      'about_places_card3_body',
      `Το Ηράκλειο είναι η μεγαλύτερη πόλη της Κρήτης και ένα από τα σημαντικότερα αστικά κέντρα της Ελλάδας. Η πόλη του αντανακλά με σαφήνεια τους διαφορετικούς πολιτισμούς που άνθισαν στο πέρασμα των αιώνων: Βυζαντινά οικοδομήματα στέκουν δίπλα σε Ενετικά δημόσια και ιδιωτικά κτίρια και Οθωμανικές...`
    );
    this.greekConfig.properties.set('about_places_card3_btn', 'ΕΞΕΡΕΥΝΗΣΤΕ');
    this.greekConfig.properties.set(
      'about_places_card4_title',
      'Άγιος Νικόλαος'
    );
    this.greekConfig.properties.set(
      'about_places_card4_body',
      `Ο Άγιος Νικόλαος είναι η σύγχρονη κοσμοπολίτικη πρωτεύουσα του νομού Λασιθίου. Κάθε καλοκαίρι πλήθος κόσμου μαζεύεται στα διάσημα μπαράκια του λιμανιού και της γραφικής λίμνης Βουλισμένης. Πάνω από τη λίμνη αναπτύσσεται μικρό πευκόφυτο πάρκο, ενώ από αυτό ξεκινά ένα πετρόχτιστο μονοπάτι που...`
    );
    this.greekConfig.properties.set('about_places_card4_btn', 'ΕΞΕΡΕΥΝΗΣΤΕ');
    this.greekConfig.properties.set(
      'about_crete_title',
      '10 λόγοι που θα ερωτευτείτε την Κρήτη'
    );
    this.greekConfig.properties.set(
      'about_crete_subheader',
      'Η Κρήτη είναι ένας τόπος γοητευτικός, που προσφέρει στον υπέρτατο βαθμό όσα μπορείτε να ονειρευτείτε για τις διακοπές σας. Σας δίνουμε δέκα κορυφαίους λόγους γι’ αυτό, αλλά σίγουρα θα ανακαλύψετε πολλούς περισσότερους όταν βρεθείτε στο νησί!'
    );
    this.greekConfig.properties.set(
      'about_crete_card1_title',
      '1. Πολιτισμός και Παραδόσεις'
    );
    this.greekConfig.properties.set(
      'about_crete_card1_body',
      `Ανακαλύψτε την πολυκύμαντη ιστορία της ανά τους αιώνες: Στα Μινωικά ανάκτορα της Κνωσού, της Φαιστού, των Μαλίων και της Ζάκρου. Στους αρχαιολογικούς χώρους της αρχαίας Γόρτυνας, Ελεύθερνας, Λύττου, Απτέρας,Φαλάσαρνας, Σπιναλόγκας… Στα ενετικά λιμάνια των Χανίων, Ηρακλείου και Ρεθύμνου. Στα οθωμανικά μνημεία και αρχιτεκτονήματα διάσπαρτα σ’ ολόκληρο το νησί. Στις ιστορικές μονές Αρκαδίου, Πρέβελης, Τοπλού, Αγκαράθου, Χρυσοσκαλίτισσας… Στα πολυάριθμα θεματικά μουσεία, ανάμεσά τους το Αρχαιολογικό Μουσείο Ηρακλείου, από τα σπουδαιότερα παγκοσμίως.`
    );
    this.greekConfig.properties.set(
      'about_crete_card2_title',
      '2. Παλιές Πόλεις'
    );
    this.greekConfig.properties.set(
      'about_crete_card2_body',
      `Στις παλιές πόλεις των Χανίων και του Ρεθύμνου κυριαρχεί ένα γοητευτικό κράμα ενετικών και οθωμανικών στοιχείων.`
    );
    this.greekConfig.properties.set(
      'about_crete_card2_body_fade',
      `Διάσημες και μαγευτικές, ποζάρουν αυτάρεσκα σε αμέτρητα φωτογραφικά ενσταντανέ, αποτυπώνοντας την αίγλη μιας άλλης εποχής. Σεργιανίστε στα στενά τους δρομάκια, ξαποστάστε σε παραδοσιακά καφενεία και ταβερνάκια και απλά αφεθείτε στη μαγεία μιας άλλης εποχής.`
    );
    this.greekConfig.properties.set(
      'about_crete_card3_title',
      '3. Παραδοσιακά Χωρία'
    );
    this.greekConfig.properties.set(
      'about_crete_card3_body',
      `Ορεινοί οικισμοί στην πλειοψηφία, όπου διατηρούνται αναλλοίωτα μέχρι σήμερα έθιμα και παραδόσεις, σάς αποκαλύπτουν αυθεντικές πτυχές της γνήσιας κρητικής κουλτούρας. Αρχάνες, Ζαρός και Ασίτες στο Ηράκλειο, Βάμος και Χώρα Σφακίων στα Χανιά, Ανώγεια, Αξός και Μαργαρίτες στο Ρέθυμνο, Μακρύγιαλος και Κριτσά στο Λασίθι… Εδώ χτυπά η ανόθευτη ψυχή της Κρήτης!`
    );
    this.greekConfig.properties.set(
      'about_crete_card4_title',
      '4. Παραθαλάσσια τουριστικά θέρετρα'
    );
    this.greekConfig.properties.set(
      'about_crete_card4_body',
      `Το παράλιο «μέτωπο» του νησιού φιλοξενεί πολυτελείς παραθεριστικές μονάδες, αλλά και παντός τύπου καταλύματα. Πέρα από τις μεγάλες πόλεις (Ηράκλειο, Χανιά, Ρέθυμνο, Άγιο Νικόλαο, Σητεία και Ιεράπετρα) αλησμόνητες διακοπές θα απολαύσετε σε: Αγία Πελαγία, Αμνισσό, Καλούς Λιμένες, Χάνι Κοκκίνη, Μάλια και Αμμουδάρα (Νομός Ηρακλείου). Πλατανιά, Αγία Μαρίνα, Κολυμπάρι, Αγία Ρουμέλη, Λουτρό, Παλαιόχωρα και Κίσσαμο (Νομός Χανίων). Γεωργιούπολη, Μπαλί, Πλακιά, Άγιο Παύλο, Πάνορμο (Νομός Ρεθύμνου). Ελούντα, Πλάκα, Μακρύγιαλος, Κουτσουνάρι, Άγια Φωτιά (Νομός Λασιθίου).`
    );
    this.greekConfig.properties.set(
      'about_crete_card5_title',
      '5. Γαστρονομία'
    );
    this.greekConfig.properties.set(
      'about_crete_card5_body',
      `Η ιδιαιτερότητα της κρητικής κουζίνας συμπυκνώνεται στη ρήση «πράμα από τον τόπο σου». Είναι αξιοθαύμαστος ο τρόπος που οι κρητικοί αξιοποιούν τα γεννήματα της πλούσιας γης τους: άφθονα οπωροκηπευτικά, εποχιακά λαχανικά, όσπρια, άγρια χόρτα και αρωματικά βότανα «παντρεύονται» με νόστιμο αιγοπρόβειο κρέας, δημιουργώντας πολλές φορές ευφάνταστα μαγειρέματα που δε συναντώνται πουθενά αλλού στην Ελλάδα. Εντυπωσιακή, εξάλλου, είναι η παλέτα των τυροκομικών, με κορωνίδα την ονομαστή γραβιέρα Κρήτης, κατοχυρωμένη διεθνώς ως τυρί με ονομασία προέλευσης.`
    );
    this.greekConfig.properties.set('about_crete_card6_title', '6. Παραλίες');
    this.greekConfig.properties.set(
      'about_crete_card6_body',
      `Η τεράστια ακτογραμμή του νησιού φιλοξενεί απειράριθμες παραλίες, στην πλειοψηφία τους αμμουδερές. Στην περιοχή των Χανίων ξεχωρίζουν οι «εξωτικές» Μπάλος, Φαλάσαρνα και Ελαφονήσι. Σε κοντινή απόσταση από το Ηράκλειο βρίσκονται η Αμνισός, η Αγία Πελαγία, οι Καλοί Λιμένες, τα Μάλια, ο Λιμένας Χερσονήσου, η Αμμουδάρα και τα «ιστορικά» Μάταλα. Στο Ρέθυμνο θα βρείτε τις μεγαλύτερες αμμουδιές (Επισκοπή, Πετρές) και ορισμένες από τις πιο «ιδιαίτερες» της Κρήτης (Τριόπετρα, Άγιος Παύλος, Λίγκρες, Φραγκοκάστελο, Πρέβελη). Το Λασίθι φημίζεται για τις γραφικές ακρογιαλιές του Λιβυκού πελάγους και την κοσμοπολίτικη Ελούντα.`
    );
    this.greekConfig.properties.set(
      'about_crete_card7_title',
      '7. Στολίδια της φύσης'
    );
    this.greekConfig.properties.set(
      'about_crete_card7_body',
    ...
    this.greekConfig.properties.set(
      'about_crete_card10_title',
      '10. Αυθεντικός τρόπος ζωής'
    );
    this.greekConfig.properties.set(
      'about_crete_card10_body',
    ...
    this.greekConfig.properties.set(
      'about_crete_btn_showmore',
      'ΔΙΑΒΑΣΤΕ ΠΕΡΙΣΣΟΤΕΡΑ'
    );
    this.greekConfig.properties.set(
      'about_crete_btn_showless',
      'ΔΙΑΒΑΣΤΕ ΛΙΓΟΤΕΡΑ'
    );
    ...
    //Gift
    this.greekConfig.properties.set("gift_page_header","Η παρουσία σας και η ευχή σας στο γάμο μας είναι τα πιο πολύτιμα δώρα για εμάς. Παρακάτω ωστόσο, υπάρχει προαιρετική λίστα γάμου για κάποιον που το επιθυμεί.");
    this.greekConfig.properties.set(
      'gift_page_copy_btn',
      'Αντιγραφή στο πρόχειρο'
    );
    ...
    this.greekConfig.properties.set(
      'wedding_page_par',
      'Είμαστε έτοιμοι να ξεκινήσουμε αυτή την τρελή περιπέτεια που ονομάζεται γάμος! Ναι, αποφασίσαμε να αγνοήσουμε τον ενθουσιασμό μας για την ελευθερία και να προχωρήσουμε σε μια δέσμευση για την υπόλοιπη ζωή μας. Με χαρά, σας προσκαλούμε στο γάμο μας που θα γίνει στις 24 Αυγούστου 2024 στο εκκλησάκι του Αγίου Νικολάου, στη Σκεπαστή Αρένα και ώρα 19.30. '
    );
    this.greekConfig.properties.set('wedding_page_subheader1', 'Οικογένειες');
    this.greekConfig.properties.set('wedding_page_text1a', 'Σιαπάκας Ιωάννης');
    this.greekConfig.properties.set('wedding_page_text1b', 'Καλλιόπη Χατζούλη');
    this.greekConfig.properties.set('wedding_page_text2a', 'Κοϊνάκης Ιωάννης');
    this.greekConfig.properties.set(
      'wedding_page_text2b',
      'Λαμπρινή Νικηφόρου'
    );
    this.greekConfig.properties.set('wedding_page_text3', 'Κουμπάροι');
    this.greekConfig.properties.set('wedding_page_text4', 'Πουλιάσης Σταμάτης');
    this.greekConfig.properties.set('wedding_page_text5', 'Δημητρίου Μαίρη');
    this.greekConfig.properties.set('wedding_page_text6', 'Βασσάλου Ελένη');
    this.greekConfig.properties.set(
      'wedding_page_bottom_txt',
      'Μετά το μυστήριο θα ακολουθήσει δεξίωση στον ίδιο χώρο.'
    );
    this.greekConfig.properties.set('wedding_page_text7a', 'Προετοιμασία');
    this.greekConfig.properties.set('wedding_page_text7b', 'γαμπρού');
    this.greekConfig.properties.set('wedding_page_text7c', 'νύφης');
    this.greekConfig.properties.set('wedding_page_text7d', 'Ώρα: 16.00');
    this.greekConfig.properties.set(
      'wedding_page_text7e',
      'Τοποθεσία: Κάλυβος Μυλοποτάμου'
    );
    ...
    this.englishConfig.properties.set(
      'home_blurb',
    ...
    this.englishConfig.properties.set(
      'home_cpl_header',
      'JOIN THODORIS & MARILENA TO CELEBRATE THEIR UNION'
    );
    this.englishConfig.properties.set(
      'home_cpl_subheader',
    ...
    this.englishConfig.properties.set(
      'home_info_loc2_cer',
      'ΕΟ Rethimnou Irakliou, Skepasti'
    );
    ...
    this.englishConfig.properties.set(
      'rsvp_phone',
      'Specify your phone number (Optional)'
    );
    this.englishConfig.properties.set(
      'rsvp_email',
      'Specify your email address (Optional)'
    );
    this.englishConfig.properties.set(
      'rsvp_subheader_people',
      'Reservation Details'
    );
    this.englishConfig.properties.set('rsvp_people_count', 'Number of people');
    this.englishConfig.properties.set(
      'rsvp_extra_attendee',
      'Enter the fullname of the attendee'
    );
    this.englishConfig.properties.set(
      'rsvp_comments',
    ...
    this.englishConfig.properties.set(
      'contact_header',
      'Send a message if you have any question and we will reach out tou you shortly'
    );
    this.englishConfig.properties.set(
      'contact_firstname',
      'Enter your first name'
    ...
    this.englishConfig.properties.set(
      'info_flight1_header',
      'Athens (ATH) to Heraklion (HER) flights'
    );
    this.englishConfig.properties.set(
      'info_flight2_header',
      'Thessaloniki (SKG) to Heraklion (HER) flights'
    );
    this.englishConfig.properties.set('info_flight_number', 'Weekly Planes');
    this.englishConfig.properties.set(
      'info_flight_duration',
      'Average Duration'
    );
    ...
    this.englishConfig.properties.set(
      'info_stay_subheader',
      'Find the best place to enjoy your stay'
    );
    this.englishConfig.properties.set(
      'info_stay_recommendations',
      'Our recommendations, according to the distance from the wedding are:'
    );
    ...
    this.englishConfig.properties.set(
      'info_stay_additional',
      'You can also travel with a ferry or airplane from Athens, Thessaloniki or Pireus to Chania, but we recommend Heraklion as it is closer to the wedding.'
    );
    ...
    this.englishConfig.properties.set(
      'info_stay_useful_phones1',
      'Health Center Peramatos'
    );
    this.englishConfig.properties.set(
      'info_stay_useful_phones2',
      'Health Center Anogion'
    );
    this.englishConfig.properties.set(
      'info_stay_useful_phones3',
      'Hospital Rethimno'
    ...
    this.englishConfig.properties.set(
      'info_stay_useful_phones4',
      'Police Departnent Perama'
    );
    this.englishConfig.properties.set(
      'info_stay_useful_phones5',
      'Traffic Police Rethimno'
    );
    this.englishConfig.properties.set(
      'info_stay_useful_phones6',
      'Fire Department Perama'
    );
    this.englishConfig.properties.set(
      'info_stay_useful_phones7',
      'Fire Department Rethimno'
    );
    this.englishConfig.properties.set(
      'info_stay_useful_phones_btn',
      'Click on it to call'
    ...
    this.englishConfig.properties.set(
      'about_subheader',
      'We propose you to combine our special day with a memorable vacation experience.'
    );
    this.englishConfig.properties.set(
      'about_top_paragraph',
    ...
    this.englishConfig.properties.set(
      'about_places_card2_body',
      'Rethymno is located in the north end of the prefecture, built by the sea and is a city with many faces. Rethymno or Rithymna as it was once called has been inhabited since the Later Minoan III period. Nowadays, it keeps the elements inherited by its history (from antiquity up to now).'
    );
    ...
    this.englishConfig.properties.set(
      'about_places_card3_body',
      'Heraklion is the largest city of Crete and one of Greece’s major urban centres. The city flourished under a multicultural influence throughout the centuries; that’s why there is a plethora of Byzantine, Venetian and Ottoman structures to look out for! The city’s landmark is the 16th c. Koules fortress.'
    );
    ...
    this.englishConfig.properties.set(
      'about_crete_card1_body',
      `Its strategic location on the map has turned the island of Crete into a crossroads where peoples
    and
    ...
    this.englishConfig.properties.set(
      'about_crete_card2_body_fade',
      `architectural elements. They are well-known, charming, and
    ...
    this.englishConfig.properties.set(
      'about_crete_card3_body',
      `They are mountain villages, mostly. Old customs and traditions are kept unchanged here and they
    unveil
    ...
    this.englishConfig.properties.set(
      'about_crete_card4_body',
      `Luxury resorts and lodgings of all types can be found along the seafront. Big towns such as
    Heraklion,
    ...
    this.englishConfig.properties.set(
      'about_crete_card5_body',
      `The essence of the Cretan cuisine can be described in the following words: “prefer the products of
    ...
    this.englishConfig.properties.set(
      'about_crete_card6_body',
      `The island’s endless coastline features numerous beaches, most of which are sandy. Balos,
    Falasarna
    ...
    this.englishConfig.properties.set(
      'about_crete_card7_body',
      `The terrain’s morphological diversity is remarkable and it offers hard-to-ignore opportunities to
    ...
    this.englishConfig.properties.set(
      'about_crete_card8_body',
      `Crete is an island that can offer many a thrill to action-loving travellers by the sea or on the
    ...
    this.englishConfig.properties.set(
      'about_crete_card9_body',
      `Visit Gavdos islet, the southernmost tip of Europe; swim by heavenly beaches such as Sarakiniko,
    Ai
    ...
    this.englishConfig.properties.set(
      'about_crete_card10_body',
      `The Cretans are proud and affable people. They are, after all, the descendants of Cretan-born Zeus
    the
    ...
    this.englishConfig.properties.set(
      'gift_page_header',
      'While the joy of having you with us on our wedding day surpasses any material gift, should you wish to contribute in another way, your support towards our journey forward would be warmly welcomed and truly valued.'
    );
    ...
    this.englishConfig.properties.set(
      'wedding_page_par',
      'We are ready to start the so called wedding adventure! Yes, we decided to ignore our entusiasm for our freedom and commit for the rest of our life. We are happy to invite you to our wedding on 24th of August 2024 in the Saint Nicolas church, in Skepasti Arena at 19:30. '
    );
    this.englishConfig.properties.set('wedding_page_subheader1', 'The Families');
    this.englishConfig.properties.set(
      'wedding_page_text1a',
      'Siapakas Ioannis'
    );
    ...
    this.englishConfig.properties.set('wedding_page_text3', 'Best man and women');
    this.englishConfig.properties.set(
      'wedding_page_text4',
      'Pouliasis Stamatis'
    );
    this.englishConfig.properties.set('wedding_page_text5', 'Dimitriou Meri');
    this.englishConfig.properties.set('wedding_page_text6', 'Vassalou Eleni');
    this.englishConfig.properties.set(
      'wedding_page_bottom_txt',
      'After the ceremony we will offer a party in the same location.'
    );
    this.englishConfig.properties.set('wedding_page_text7a', 'The preparation of');
    this.englishConfig.properties.set('wedding_page_text7b', 'groom');
    this.englishConfig.properties.set('wedding_page_text7c', 'pride');
    this.englishConfig.properties.set('wedding_page_text7d', 'Time: 16.00');
    this.englishConfig.properties.set(
      'wedding_page_text7e',
      'Location: Kalivos Milopotamou'
    );

    this.englishConfig.properties.set('thank_you', 'Thank you');
    this.englishConfig.properties.set('contact_submit_banner', 'We will contact you as soon as possible');

    this.englishConfig.properties.set('thankyou_banner_positive', 'We are so happy and we are waiting you at 24th of August to celebrate together');
    this.englishConfig.properties.set('thankyou_banner_negative', 'We are so sorry to hear that you will not be with us but thank you for your response');
  }
}
